...
function ProductList() {
  ...
  const handleContinueShopping = () => {
    setShowCart(false);
    setButtonStates({}); // Resetea el estado de los botones para habilitarlos nuevamente
  };

  const handleAddToCart = (plant) => {
    dispatch(addItem(plant));
    setButtonStates((prevState) => ({ ...prevState, [plant.name]: true }));
  };
                  ...
                  <div key={i} className="product-card">
                    ...
                    <button
                      className={`product-button ${
                        buttonStates[plant.name] ? "disabled" : ""
                      }`}
                      onClick={() => handleAddToCart(plant)}
                      disabled={buttonStates[plant.name]}
                    >
                      {" "}
                      {buttonStates[plant.name]
                        ? "Added to Cart"
                        : "Add to Cart"}{" "}
                    </button>
                  </div>
